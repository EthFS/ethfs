...
interface FileSystem {
  ...
  function stat(bytes calldata path, uint curdir) external view returns (FileType fileType, uint16 mode, uint ino_, uint links, address owner, address group, uint nEntries, uint size, uint lastModified);
  function lstat(bytes calldata path, uint curdir) external view returns (FileType fileType, uint16 mode, uint ino_, uint links, address owner, address group, uint nEntries, uint size, uint lastModified);
  function fstat(uint ino) external view returns (FileType fileType, uint16 mode, uint ino_, uint links, address owner, address group, uint nEntries, uint size, uint lastModified);
}
